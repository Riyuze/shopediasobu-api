...
declare const _default: {
    getProductsByRefId: (id: string) => Promise<Omit<import("mongoose").Document<unknown, {}, {
        url: string;
        title: string;
        price: number;
        image: string;
    ...
    addProduct: (newProductData: ProductRequest) => Promise<import("mongoose").Document<unknown, {}, {
        url: string;
        title: string;
        price: number;
        image: string;
